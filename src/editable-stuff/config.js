...
const mainBody = {
  ...
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/heyyitsemyy",
    },
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/emilyng121999/",
    },
  ],
};
...
const about = {
  ...
  resume: "https://drive.google.com/file/d/1Z4pGUopr9wHb_L52vv0LAyWEvhxeCP46/view?usp=sharing",
};
...
const repos = {
  ...
  gitHubUsername: "heyyitsemyy", //i.e."johnDoe12Gh"
  reposLength: 0,
  specificRepos: ['MRI-Classification', 'Limbal_Stem_Cell_Deficiency', 'M228_Sleep_Classifier', 'GWAS'],
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/Q38A0386.png"), 
...
const getInTouch = {
  ...
  message:
  "I'm currently looking for full-time Data Science or Machine Learning opportunities! If you know of any positions available, if you have any questions, or if you just want to reach out, please feel free to email me at",
  email: "emilyn1999@g.ucla.edu",
};
